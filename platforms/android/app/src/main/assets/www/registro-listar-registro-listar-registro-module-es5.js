...
var ListarRegistroPageModule = /** @class */ (function () {
    function ListarRegistroPageModule() {
    }
    ...
    return ListarRegistroPageModule;
}());
...
var ListarRegistroPage = /** @class */ (function () {
    function ListarRegistroPage(fire) {
        this.fire = fire;
        this.listaRegistro = this.fire.list('registro').snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (lista) { return lista.map(function (linha) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ key: linha.payload.key }, linha.payload.val())); }); }));
    }
    ListarRegistroPage.prototype.ngOnInit = function () {
    };
    ListarRegistroPage.prototype.excluir = function (key, registro) {
        this.fire.object('registro/' + key).remove();
        this.fire.object('message/' + key).remove();
    };
    ListarRegistroPage.ctorParameters = function () { return [
...
//# sourceMappingURL=registro-listar-registro-listar-registro-module-es5.js.map