...
var map = {
	...
	"./curso/curso-listar/curso-listar.module": [
		"./src/app/curso/curso-listar/curso-listar.module.ts",
		"curso-curso-listar-curso-listar-module"
	],
	"./curso/salvar-curso/salvar-curso.module": [
		"./src/app/curso/salvar-curso/salvar-curso.module.ts",
		"curso-salvar-curso-salvar-curso-module"
	],
	"./estado/listar/listar.module": [
	...
	"./materia/listar-materia/listar-materia.module": [
		"./src/app/materia/listar-materia/listar-materia.module.ts",
		"materia-listar-materia-listar-materia-module"
	],
	"./materia/salvar-materia/salvar-materia.module": [
		"./src/app/materia/salvar-materia/salvar-materia.module.ts",
		"materia-salvar-materia-salvar-materia-module"
	],
	"./pagina/pagina.module": [
		"./src/app/pagina/pagina.module.ts",
		"pagina-pagina-module"
	],
	"./registro/listar-registro/listar-registro.module": [
		"./src/app/registro/listar-registro/listar-registro.module.ts",
		"registro-listar-registro-listar-registro-module"
	],
	"./registro/salvar-registro/salvar-registro.module": [
...
module.exports = __webpack_require__(/*! /home/aluno/Área de Trabalho/IonicAssociacao/src/main.ts */"./src/main.ts");
