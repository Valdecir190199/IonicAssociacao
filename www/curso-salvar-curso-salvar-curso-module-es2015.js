...
let SalvarCursoPageModule = class SalvarCursoPageModule {
};
...
let SalvarCursoPage = class SalvarCursoPage {
    constructor(banco, rota, route) {
        this.banco = banco;
        this.rota = rota;
        this.route = route;
...
SalvarCursoPage.ctorParameters = () => [
...
//# sourceMappingURL=curso-salvar-curso-salvar-curso-module-es2015.js.map